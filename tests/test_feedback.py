...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Test command could not be started: FileNotFoundError.", 1, False, FailureCategory.ENVIRONMENT_ERROR),
        ("Bash/Service/CreateInstance/E_ACCESSDENIED", 1, False, FailureCategory.ENVIRONMENT_ERROR),
        ("couldn't create signal pipe, Win32 error 5", 1, False, FailureCategory.ENVIRONMENT_ERROR),
        ("PermissionError: [WinError 5] Access is denied", 1, False, FailureCategory.ENVIRONMENT_ERROR),
        ("FileNotFoundError: executable was not found", 1, False, FailureCategory.ENVIRONMENT_ERROR),
