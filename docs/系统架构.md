...
| code    | `SPEC.md`、`PLAN.md`、相关代码片段、允许工具、允许修改范围、protected patterns          |
...
9. 输出为纯数据字典：`task_id`、`phase`、`goal`、`sections`、`context_risks` 与
   `truncation`；ContextBuilder 不写入 state 或 trace，副作用由后续 AgentLoop 集成负责。
